...
public class Clock extends Application
{
	...
	public void start(Stage stage) throws Exception
	{
		...
		double clock_Start_Seconds = calendar.get(Calendar.SECOND) * (360 / 60);
		double clock_Start_Minutes = (calendar.get(Calendar.MINUTE) + clock_Start_Seconds / 360.0) * (360 / 60);
		double clock_Start_Hours = (calendar.get(Calendar.HOUR) + clock_Start_Minutes / 360.0) * (360 / 12);
	...
	{
		clock_Seconds_Time_Rate.pause();
		clock_Minutes_Time_Rate.pause();
		clock_Hours_Time_Rate.pause();
	}
